...
origins = [
    "http://localhost:5173",
    "http://localhost:3000",
    "https://electronicshotdeals.onrender.com",  # Example Render URL
    "https://electronics-hot-deals.vercel.app",  # Example Vercel URL
]

app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allow all for portfolio demo simplicity
